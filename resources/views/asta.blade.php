...
<body>
  ...
  <section id="hero">
    <div class="hero-container">
      ...
      <h2>The multi company that provide broad benefits to many people</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
            <div class="box">
              ...
              <h4 class="title"><a href="">Multimedia</a></h4>
              <p class="description">Design Grafis dan Percetakan</p>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.4s">
            <div class="box">
          ...
          <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
            <div class="box">
              ...
              <p class="description">Advertising - Jasa Periklanan</p>
            </div>
          </div>
        </div>
      ...
      <div class="container wow fadeInUp">
        ...
        <div class="row" id="portfolio-wrapper">
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/app1.jpg')}}" alt="">
              <div class="details">
                <h4>App 1</h4>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/web2.jpg')}}" alt="">
              <div class="details">
                <h4>Web 2</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/app3.jpg')}}" alt="">
              <div class="details">
                <h4>App 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/card1.jpg')}}" alt="">
              <div class="details">
                <h4>Card 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/card2.jpg')}}" alt="">
              <div class="details">
                <h4>Card 2</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/web3.jpg')}}" alt="">
              <div class="details">
                <h4>Web 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-card">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/card3.jpg')}}" alt="">
              <div class="details">
                <h4>Card 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-app">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/app2.jpg')}}" alt="">
              <div class="details">
                <h4>App 2</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/logo1.jpg')}}" alt="">
              <div class="details">
                <h4>Logo 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/logo3.jpg')}}" alt="">
              <div class="details">
                <h4>Logo 3</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-web">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/web1.jpg')}}" alt="">
              <div class="details">
                <h4>Web 1</h4>
                <span>Alored dono par</span>
              </div>
          ...
          <div class="col-lg-3 col-md-6 portfolio-item filter-logo">
            <a href="">
              <img src="{{ asset('regna/img/portfolio/logo2.jpg')}}" alt="">
              <div class="details">
                <h4>Logo 2</h4>
                <span>Alored dono par</span>
              </div>
    ...
    <section id="team">
      <div class="container wow fadeInUp">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('regna/img/team-3.jpg')}}" alt=""></div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="member">
              <div class="pic"><img src="{{ asset('regna/img/team-4.jpg')}}" alt=""></div>
              <h4>Amanda Jepson</h4>
  ...
  <footer id="footer">
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright 2019 by <strong>Asta Multimedia Tama</strong>. All Rights Reserved
      </div>
      <div class="credits">
        <!--
