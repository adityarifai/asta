                                            ...
                                            <div class="carousel-inner" role="listbox">
                                                <div class="carousel-item active">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="{{asset('adminbite/assets/images/big/img1.jpg')}}" alt="First slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="{{asset('adminbite/assets/images/big/img2.jpg')}}" alt="Second slide">
                                                    </div>
                                                </div>
                                                <div class="carousel-item">
                                                    <div class="container p-0">
                                                        <img class="d-block img-fluid" src="{{asset('adminbite/assets/images/big/img3.jpg')}}" alt="Third slide">
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <ul class="list-style-none">
                                    ...
                                    <li>
                                        <div class="message-center message-body">
                                            ...
                                            <a href="javascript:void(0)" class="message-item">
                                                <span class="user-img">
                                                    <img src="{{asset('adminbite/assets/images/users/1.jpg')}}" alt="user" class="rounded-circle">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li class="sidebar-item">
                            <a class="sidebar-link waves-effect waves-dark sidebar-link" href="{{asset('adminbite/docs/documentation.html
                                   ')}}" aria-expanded="false">
                        ...
                        <div class="card">
                            ...
                            <div class="comment-widgets scrollable" style="height:560px;">
                                ...
                                <div class="d-flex flex-row comment-row m-t-0">
                                    <div class="p-2">
                                        <img src="{{asset('adminbite/assets/images/users/1.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('adminbite/assets/images/users/2.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('adminbite/assets/images/users/5.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                ...
                                <div class="d-flex flex-row comment-row">
                                    <div class="p-2">
                                        <img src="{{asset('adminbite/assets/images/users/6.jpg')}}" alt="user" width="50" class="rounded-circle">
                                    </div>
                                    <div class="comment-text w-100">
                                        <h6 class="font-medium">James Anderson</h6>
                                        <span class="m-b-15 d-block">Lorem Ipsum is simply dummy text of the printing and type setting industry. </span>
                            ...
                            <div class="card-body">
                                ...
                                <div class="chat-box scrollable position-relative" style="height:475px;">
                                    ...
                                    <ul class="chat-list">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="{{asset('adminbite/assets/images/users/1.jpg')}}" alt="user">
                                            </div>
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="{{asset('adminbite/assets/images/users/2.jpg')}}" alt="user">
                                            </div>
                                            <div class="chat-content">
                                        ...
                                        <li class="chat-item">
                                            <div class="chat-img">
                                                <img src="{{asset('adminbite/assets/images/users/3.jpg')}}" alt="user">
                                            </div>
                                            <div class="chat-content">
